...
class LogWriter:
    ...
    #                                          #
    ############################################
    def construct(self, fn, program_title, version, priority_restrictions = 1):
        self.fn = fn
        self.program_title = program_title
        self.version = version
        self.log_file = open(self.fn, "w+")
        self.write(0, "{} {} log".format(self.program_title, self.version))
    ...
    def flush_cue(self):
        for i in range(0, len(self.cue) - 1):
            self.re_write(self.cue_priority[i], self.cue[i])
